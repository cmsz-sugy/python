...
def QR_login():
    ...
    browser=webdriver.PhantomJS(executable_path="D:\\phantomjs-2.1.1-windows\\phantomjs-2.1.1-windows\\bin\\phantomjs.exe")#这里要输入你的phantomjs所在的路径
